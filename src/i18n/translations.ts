...
export const translations: Record<Language, Record<string, string>> = {
  ...
  nl: {
    ...
    "about.figures.cities": "Aanwezig in Brussel en Gent, direct bereikbaar, geen afstand tussen advies en uitvoering.",
    "about.figures.experience": "31 jaar ervaring, rechtstreeks betrokken bij elk project — geen wisselende teams.",
    "about.figures.projects": "100+ werkplektransities succesvol opgeleverd.",
