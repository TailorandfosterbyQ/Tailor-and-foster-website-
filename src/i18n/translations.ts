...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "usps.disruption.text": "We control the time diverted away from your core business.",
    ...
    "services.hero.title": "Office Transition Management",
    "services.hero.text": "We offer a complete solution to the stress of moving, renovating, or rethinking your workplace. From first scan to final handover.",
    "services.process.label": "Our approach",
    "services.process.title": "The journey, step by step.",
    "services.process.step1.title": "Initial Opportunity Scan",
    "services.process.step1.text": "We evaluate your current lifetime costs, lease obligations, and workspace utilization.",
    "services.process.step2.title": "Strategic Roadmap",
    "services.process.step2.text": "We define a path tailored to your specific goals — stay, move, expand, or consolidate.",
    "services.process.step3.title": "Collaborative Execution",
    "services.process.step3.text": "We join forces with vetted specialists and manage the project to completion.",
    "services.forWhom.label": "For whom?",
    "services.forWhom.title": "Is this for you?",
    "services.forWhom.text": "Our services are designed for businesses facing organizational growth, downsizing, or lease expiration. If your workspace no longer serves your team, we can help.",
  ...
  nl: {
    ...
    // Services page
    "services.hero.label": "Onze diensten",
    "services.hero.title": "Kantoortransitiemanagement",
    "services.hero.text": "Wij bieden een complete oplossing voor de stress van verhuizen, renoveren of het herdenken van uw werkplek. Van eerste scan tot finale oplevering.",
    "services.process.label": "Onze aanpak",
    "services.process.title": "Het traject, stap voor stap.",
    "services.process.step1.title": "Initiële Opportunity Scan",
    "services.process.step1.text": "Wij evalueren uw huidige levensduurkosten, huurverplichtingen en werkplekbenutting.",
    "services.process.step2.title": "Strategisch Stappenplan",
    "services.process.step2.text": "Wij definiëren een pad op maat van uw specifieke doelen — blijven, verhuizen, uitbreiden of consolideren.",
    "services.process.step3.title": "Gezamenlijke Uitvoering",
    "services.process.step3.text": "Wij bundelen onze krachten met gecontroleerde specialisten en beheren het project tot voltooiing.",
    "services.forWhom.label": "Voor wie?",
    "services.forWhom.title": "Is dit voor u?",
    "services.forWhom.text": "Onze diensten zijn ontworpen voor bedrijven die te maken hebben met organisatorische groei, inkrimping of het aflopen van een huurcontract. Als uw werkplek uw team niet meer dient, kunnen wij helpen.",
  ...
  fr: {
    ...
    // Services page
    "services.hero.label": "Nos services",
    "services.hero.title": "Gestion de transition de bureaux",
    "services.hero.text": "Nous offrons une solution complète au stress du déménagement, de la rénovation ou de la refonte de votre lieu de travail. Du premier scan à la remise finale.",
    "services.process.label": "Notre approche",
    "services.process.title": "Le parcours, étape par étape.",
    "services.process.step1.title": "Opportunity Scan initial",
    "services.process.step1.text": "Nous évaluons vos coûts actuels sur la durée de vie, vos obligations de bail et l'utilisation de vos espaces.",
    "services.process.step2.title": "Feuille de route stratégique",
    "services.process.step2.text": "Nous définissons un chemin adapté à vos objectifs spécifiques — rester, déménager, étendre ou consolider.",
    "services.process.step3.title": "Exécution collaborative",
    "services.process.step3.text": "Nous unissons nos forces avec des spécialistes vérifiés et gérons le projet jusqu'à son achèvement.",
    "services.forWhom.label": "Pour qui ?",
    "services.forWhom.title": "Est-ce pour vous ?",
    "services.forWhom.text": "Nos services sont conçus pour les entreprises confrontées à la croissance organisationnelle, à la réduction ou à l'expiration de bail. Si votre espace de travail ne sert plus votre équipe, nous pouvons vous aider.",
