...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.figures.cities.desc": "Directly accessible, no distance between advice and execution.",
    "about.figures.experience.title": "31 years of experience",
    "about.figures.experience.desc": "Directly involved in every project, no changing teams.",
    "about.figures.projects.title": "100+ workplace transitions",
    "about.figures.projects.desc": "Successfully delivered, from first analysis to full implementation.",
    ...
    "opportunityScan.hero.cta": "Fill in the form below and we will reach out to schedule a moment.",
    ...
    "opportunityScan.form.title": "Contact us",
    "opportunityScan.form.name": "Name",
    "opportunityScan.form.company": "Company name",
    "opportunityScan.form.email": "Email address",
    "opportunityScan.form.phone": "Phone number",
    ...
    "opportunityScan.form.success": "Thank you, we will contact you within 48 hours to schedule a moment.",
