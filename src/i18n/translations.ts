...
export const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    "about.figures.cities.title": "Présence à Bruxelles et Gand",
    "about.figures.cities.desc": "Directement accessibles, aucune distance entre le conseil et l'exécution.",
    "about.figures.experience.title": "31 ans d'expérience",
    "about.figures.experience.desc": "Directement impliqués dans chaque projet, aucune équipe changeante.",
    "about.figures.projects.title": "Plus de 100 transitions d'espaces de travail",
    "about.figures.projects.desc": "Livrées avec succès, de la première analyse à la mise en œuvre complète.",
    ...
    "opportunityScan.hero.cta": "Remplissez le formulaire ci-dessous et nous vous contacterons pour convenir d'un moment.",
    ...
    "opportunityScan.form.company": "Nom de l'entreprise",
    "opportunityScan.form.email": "Adresse e-mail",
    "opportunityScan.form.phone": "Numéro de téléphone",
    "opportunityScan.form.topic": "Quel est votre défi de bureau ?",
    ...
    "opportunityScan.form.success": "Merci, nous vous contacterons dans les 48 heures pour convenir d'un moment.",
    "opportunityScan.form.error": "Une erreur s'est produite. Veuillez réessayer ou nous écrire directement.",
