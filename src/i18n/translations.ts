...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.mission.text": "To redefine how organisations think about their work environment — transforming space into a strategic asset through independent advice, tailored solutions, and seamless execution.",
  ...
  nl: {
    ...
    "about.mission.text": "Herdefiniëren hoe organisaties over hun werkomgeving denken — ruimte transformeren tot een strategisch middel door onafhankelijk advies, oplossingen op maat en naadloze uitvoering.",
  ...
  fr: {
    ...
    "about.mission.text": "Redéfinir la façon dont les organisations perçoivent leur environnement de travail — transformer l'espace en un atout stratégique grâce à des conseils indépendants, des solutions sur mesure et une exécution sans faille.",
